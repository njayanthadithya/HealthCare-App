...
public class Clinicianworkareapanel extends javax.swing.JPanel {
    ...
    public Clinicianworkareapanel(JPanel userProcessContainer,  UserAccount userAccount,PhysicianOrganization organization, Enterprise enterprise, EcoSystem ecosystem) {
