...
public class ScheduleEmergencyServiceJPanel extends javax.swing.JPanel {
    ...
    private EmergencyPatientDirectory EMSPatientDirectory;
    private EmergencyPatient EMSPatient;
    private int flag = 0;
    private Patient patientToTransfer;
    private Enterprise toEnterprise;

    ScheduleEmergencyServiceJPanel(JPanel userProcessContainer, Useraccount userAccount, Enterprise enterprise, EmergencyPatientDirectory EMSPatientDirectory, EmergencyPatient EMSPatient, Organization organization, Ambulance vehicle) {
    ...
    private void comboBoxLocalityActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboBoxLocalityActionPerformed
        ...
        for (Ambulance vehicle : vehicleInformationList.getAmbulancelist()) {
            if (String.valueOf(comboBoxLocality.getSelectedItem()).equals(vehicle.getAvailability_locality()) && vehicle.isAvailability() == true) {
                txtVehicleNo.setText(vehicle.getAmbulancenumber());
                return;
            } else {
    ...
    private void btnScheduleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnScheduleActionPerformed
        ...
        this.EMSPatient = new EmergencyPatient(patientName, contactNo, source, destination);
        EMSPatientDirectory.addEMSPatient(this.EMSPatient);

        for (Ambulance v : vehicleInformationList.getAmbulancelist()) {
            if (v.getAmbulancenumber().equals(vehicleNo)) {
                this.vehicle = v;
                this.vehicle.setAmbulancenumber(vehicleNo);
        ...
        if(patientToTransfer != null){
            ...
            tq.setRecieverenterprise(toEnterprise);
        ...
        if (enterprise.getEnterprisetype() == Enterprise.EnterpriseType.EmergencyCare) {
            for (Organization org : enterprise.getOrganizationdirectory().getOrglist()) {
                ...
                if (org instanceof Emergencycareorganization) {
                    organization = org;
    ...
    private void btnBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBackActionPerformed
        ...
        for (Component comp : comps) {
            if (comp instanceof Emergencymanagerpanel) {
                Emergencymanagerpanel createP = (Emergencymanagerpanel) comp;
