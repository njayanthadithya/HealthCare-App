...
public class Sendreqpanel extends javax.swing.JPanel {
    ...
    public Sendreqpanel(JPanel userProcessContainer, Bloodgroup bloodgroup, Bloodgrouplist bloodgrouplist, Enterprise enterprise, Useraccount userAccount, EcoSystem ecosystem) {
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if (bloodGroupComboBox.getSelectedIndex() < 0 || reqUnitsTextField.getText().trim().isEmpty()) {
            ...
            for (Bloodgroup bg : bloodgrouplist.getBloodgrplist()) {
                if (bg.getBloodgrp().equals(bloodgroup)) {
                    this.bloodgroup = bg;
                }
            }
...
//    }
    ...
    public void updateDetails() {
        ...
        bloodGroupComboBox.setSelectedItem(bloodgroup.getBloodgrp());
