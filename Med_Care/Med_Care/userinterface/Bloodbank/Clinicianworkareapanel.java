 ...
 * @author harshi
 */
public class Clinicianworkareapanel extends javax.swing.JPanel {

    /**
     * Creates new form Clinicianworkareapanel
     */
    ...
    public Clinicianworkareapanel(JPanel userProcessContainer,  Useraccount userAccount,Clinicianorganization organization, Enterprise enterprise, EcoSystem ecosystem) {
        initComponents();
    ...
    private void btnUpdateBloodUnitsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateBloodUnitsActionPerformed
        ...
        if (selectedrow >= 0) {
            ...
            Viewblooddetailspanel panel = new Viewblooddetailspanel(userProcessContainer, bg, bloodgrouplist,enterprise,userAccount);
    ...
    private void btnBloodReqActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBloodReqActionPerformed
        ...
        if (selectedrow >= 0) {
            ...
            Sendreqpanel panel = new Sendreqpanel(userProcessContainer, bloodgroup, bloodgrouplist, enterprise, userAccount, ecosystem);
    ...
    private void btnEMSReq1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEMSReq1ActionPerformed
        ...
        Emergencyreqpanel panel = new Emergencyreqpanel(userProcessContainer, bloodgroup, bloodgrouplist, enterprise, userAccount, ecosystem);
        userProcessContainer.add("CreateJPanel", panel);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer);
    ...
    private void btnViewReq1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewReq1ActionPerformed
        ...
        Clinicianworkreqpanel panel = new Clinicianworkreqpanel(userProcessContainer, bloodgroup, bloodgrouplist, enterprise, userAccount, ecosystem);
        userProcessContainer.add("CreateJPanel", panel);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer);
