...
public class prescribeJPanel extends javax.swing.JPanel {
    ...
    public void staticmeds() {
        ...
        dtm.setRowCount(0);
        for (Medicine loc : this.medList.getMedicationlist()) {
    ...
    public void populateTable() {
        ...
        dtm.setRowCount(0);
        for (Medicine loc : patient.getMedList().getMedicationlist()) {
            if (!loc.isIsdischarged()) {
                ...
                for (MedicineAdministration medAdmin : loc.getMedicineadmin()) {
                    ...
                    for (String s : allergy.getCmp()) {
                        if (med.getCmpname1().equals(s) || med.getCmpname2().equals(s)) {
                            ...
                            if (option == JOptionPane.YES_OPTION) {
                                patient.getMedList().addMedicine(med, Integer.parseInt(TxtDays.getText()), Integer.parseInt(Txttimes.getText()));
