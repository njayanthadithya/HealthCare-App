...
import userinterface.Emergency.Emergencymanager.Createambulancepanel;
 ...
 * @author ksahi
 */
public class Manageambulancepanel extends javax.swing.JPanel {

    /**
     * Creates new form Manageambulancepanel
     */
    ...
    public Manageambulancepanel(JPanel userProcessContainer, Organization organization, Enterprise enterprise, UserAccount useraccount) {
        ...
        Manageambulancepanel.this.gettable();
    }
    ...
    private void btnViewFullDetailsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewFullDetailsActionPerformed
        ...
        if (selectedRow < 0) {
            ...
            Ambulance ambulance = (Ambulance) searchTable.getValueAt(selectedRow, 0);
            Ambulancedetpanel panel = new Ambulancedetpanel(userProcessContainer, ambulancedirectory, ambulance);
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
       ...
       logger.log(Level.INFO, "btnCreateActionPerformed --Manageambulanceservicepanel");
        Createambulancepanel createVehicleJPanel = new Createambulancepanel(userProcessContainer, ambulancedirectory, ambulance);
