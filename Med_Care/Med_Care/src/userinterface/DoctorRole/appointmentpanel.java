...
import userinterface.AdministrativeRole.TransferReqJpanel;
...
public class appointmentpanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        reqccbtn = new javax.swing.JButton();
        jScrollPane5 = new javax.swing.JScrollPane();
        patienttable3 = new javax.swing.JTable();
        Covidcare = new javax.swing.JComboBox<>();
        ...
        patienttable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Patient Name", "Patient HRN", "Locations"
            }
        ));
        ...
        add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 290, 361, 99));
        ...
        add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 290, -1, 100));
        ...
        add(dischargebt, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 410, 80, 29));
        ...
        add(bloodBanks, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 410, 90, 30));
        ...
        add(reqbloodbt, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 400, 100, 29));
        ...
        add(backbt, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 30, 120, 29));

        reqccbtn.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        reqccbtn.setText("Request Covid Care");
        reqccbtn.setBorder(javax.swing.BorderFactory.createEtchedBorder(null, new java.awt.Color(110, 208, 202)));
        reqccbtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                reqccbtnActionPerformed(evt);
            }
        });
        add(reqccbtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 560, 140, 29));
        ...
        patienttable3.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Patient", "Covid CareType", "Units", "Status"
            }
        ));
        jScrollPane5.setViewportView(patienttable3);

        add(jScrollPane5, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 450, -1, 100));

        Covidcare.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select" }));
        Covidcare.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                CovidcareActionPerformed(evt);
            }
        });
        add(Covidcare, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 560, 90, 30));
    ...
    private void reqccbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_reqccbtnActionPerformed
        // TODO add your handling code here:
        logger.log(Level.INFO, "reqccarebtnActionPerformed --appointmentpanel");
            
            if (Covidcare.getSelectedIndex() == 0) {
            JOptionPane.showMessageDialog(userProcessContainer, "Select the Covid care");
            return;
            }
            ...
            CCareRequirementsreqPanel panel = new CCareRequirementsreqPanel(userProcessContainer, pat, enterprise,ecosystem, useraccount);
            userProcessContainer.add("ccarereqPanel", panel);
            CardLayout layout = (CardLayout) userProcessContainer.getLayout();
            layout.next(userProcessContainer);
        } 
        else 
    ...
    }//GEN-LAST:event_reqccbtnActionPerformed
    ...
    private void CovidcareActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CovidcareActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_CovidcareActionPerformed
        ...
        for (Network network : ecosystem.getNetworkList()) {
            for (Enterprise enterprise : network.getEnterprisedirectory().getEnterpriselist()) {
                if (enterprise.getEnterprisetype() == Enterprise.EnterpriseType.CovidCare) {
                    Covidcare.addItem(enterprise.getOrganzationName());
                }
            }
        }
    }
 ...
 //for covidcaretype table
  public void getccarereq() {
       logger.log(Level.INFO, "getccarereq --appointmentpanel");

        DefaultTableModel mod = (DefaultTableModel) patienttable3.getModel();
        mod.setRowCount(0);
        for (WorkRequest workreq : useraccount.getWorkqueue().getWorkRequestAList()) {
            if (workreq.getClass().getName().contains("ccarerequestTocovidcentrefromHospital")) {
                Object[] row = new Object[4];
...
//for transfer req table 
    ...
    private javax.swing.JComboBox<String> Covidcare;
    ...
    private javax.swing.JButton reqccbtn;
