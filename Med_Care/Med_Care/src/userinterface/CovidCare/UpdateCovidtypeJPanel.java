...
public class UpdateCovidtypeJPanel extends javax.swing.JPanel {
    ...
    public UpdateCovidtypeJPanel(JPanel userProcessContainer, CovidCareRequirementType cctype, CovidCareList cclist, Enterprise enterprise,UserAccount useraccount) {
          logger.log(Level.INFO, "ccUpdatecenterJPanel");
        initComponents();
        ...
        logger.log(Level.INFO, "updateDetails --ccUpdatecctypeJPanel");

       cctypetxt.setText(cctype.getRequirementType());
        String cctypeunits = cctype.getAvailUnits();
        availunitstxt.setText(cctypeunits);

        cctypetxt.setEnabled(false);
    ...
    private void initComponents() {
        ...
        cctypetxt = new javax.swing.JTextField();
        ...
        jLabel4.setText("Update Covid Care Requirements Details");
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 30, 770, -1));

        jLabel2.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel2.setText("Requirement Type:");
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 137, 120, 30));
        ...
        add(backbt, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, 90, 29));
        ...
        add(cctypetxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 140, 116, -1));
    ...
    private void NoofunitstxtKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NoofunitstxtKeyTyped
        // TODO add your handling code here:
        logger.log(Level.INFO, "NoofunitstxtKeyTyped --CCUpdatecenterJPanel");
    ...
    private void updatebtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updatebtActionPerformed
        // TODO add your handling code here:
        logger.log(Level.INFO, "updatebtActionPerformed --CCUpdatecenterJPanel");
    ...
    private void backbtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backbtActionPerformed
        ...
        logger.log(Level.INFO, "backbtActionPerformed --CCUpdatecentertypeJPanel");
    ...
    private void savebtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_savebtActionPerformed
        // TODO add your handling code here:
        logger.log(Level.INFO, "savebtActionPerformed --CCUpdateCentertypeJPanel");

        try{
            String ot = cctypetxt.getText();
            String nu = Noofunitstxt.getText();
            int newUnits = Integer.parseInt(nu);
            int existingUnits = Integer.parseInt(cctype.getAvailUnits());
            ...
            if(nu.isEmpty() || nu == null )
            {
                ...
                cctype.setRequirementType(ot);
                cctype.setAvailUnits(totalUnits);
                JOptionPane.showMessageDialog(null, "ccType details updated successfully");
            }
        }
    ...
    private javax.swing.JTextField cctypetxt;
