...
public class CovidManagerWorkArea extends javax.swing.JPanel {
    ...
    private List<Map.Entry<String, Integer>> topCovidreqtype;
    private List<Map.Entry<String, Integer>> topRequests;
    private CovidCareRequirementType covidReqtype;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Covid Care Manager Work area");
        ...
        jButton1.setText("Top 3 Requested Covid Care Requirements");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        FindTop3RequestedCovidCareRequirements();
        ...
        try {
            ...
            for (CovidCareRequirementType ot : enterprise.getCCareList().getCCareTypeAList()) {
                ...
                if (ot.getRequirementType().equalsIgnoreCase("RTPCR")) {
                    ...
                    Rapidtestkits = Integer.parseInt(ot.getAvailUnits());
            ...
            dataSet.setValue("Rapid Test", Rapidtestkits);
            dataSet.setValue("Ventilator", Ventilator);
           

            JFreeChart chart = ChartFactory.createPieChart3D("Pie Chart for Available Units", dataSet, true, true, Locale.ENGLISH);
    ...
    public void FindTop3RequestedCovidCareRequirements() {
        logger.log(Level.INFO, "FindTop3covidcareRequest --ManagerRoleWorkAreaJPanel");
            ...
            for (Network network : ecosystem.getNetworkList()) {
                if (enterprise.equals(this.enterprise)) {
                    ...
                    for (WorkRequest request : enterprise.getWorkqueue().getWorkRequestAList()) {
                        ...
                        if (request.getClass().getName().contains("Covid care requirements from center to hospital")) {
                            ...
                            System.out.println("userinterface.CovidCare.CovidManagerWorkArea.findTop3BloodRequest()"+((CCarerequestToCCarefromHospital) request).getCcareType());
                        ...
                        } else if (request.getClass().getName().contains("CCarerequestToCCarefromEMS")) {
                ...
                if (volMap.entrySet().size() <= 3) {
                    for (Map.Entry<String, Integer> entry : list) {
                        ...
                        dataSet.setValue(entry.getValue(), "No of covid care req Units", entry.getKey());
                    }
                ...
                JFreeChart piechart = ChartFactory.createBarChart(" Top 3 Requested Covid Care Requirements ", "Covidcare requirement type", "Quantity", dataSet, PlotOrientation.VERTICAL, false, true, false);
                piechart.setBackgroundPaint(Color.WHITE);
                piechart.getTitle().setPaint(Color.BLUE);
                CategoryPlot plot = piechart.getCategoryPlot();
                plot.setBackgroundPaint(Color.CYAN);

                ChartFrame frame = new ChartFrame("Bar Chart for Top 3 Requested Covid Care Requirements ", piechart);
