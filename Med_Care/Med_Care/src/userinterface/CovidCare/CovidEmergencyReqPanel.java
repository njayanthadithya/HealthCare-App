...
public class CovidEmergencyReqPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        manageEnt1.setText("Emergency  Requests:");
        ...
        add(assignbt, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 280, 80, 29));
        ...
        add(backbt, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 80, 29));
    ...
    private void acceptbtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_acceptbtActionPerformed
        ...
        if (rowCount == 1) {
            ...
            if (wq.getTaskStatus().equals("Pending")) {
                ...
                String reqccaretype = ((CCarerequestToCCarefromEMS) wq).getCCareType();
                for (CovidCareRequirementType ot : this.requirementlist.getCCareTypeAList()) {
                    if (ot.getRequirementType().equals(reqccaretype)) {
                ...
                for (CovidCareRequirementType ot : this.requirementlist.getCCareTypeAList()) {
                    if (ot.getRequirementType().equals(reqccaretype)) {
                        if (Integer.parseInt(ot.getAvailUnits()) > BorrowedUnits) {
                            ...
                            JOptionPane.showMessageDialog(null, "Available covid care units are lesser than the requested units, Please Decline the Request");
                        }
                    }
