...
import userinterface.BloodBank.Physicianworkareapanel;
...
public class PhysicianRole extends Role{
    ...
    public JPanel createWorkArea(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, EcoSystem business) {
        return new Physicianworkareapanel(userProcessContainer, account, (PhysicianOrganization)organization, enterprise, business);
